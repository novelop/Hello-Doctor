			...
			<div class="col-md-13" style="padding: 3px">
				<div class="card card-outline card-info">
					<div class="card-header row" style="margin-right: 0px; margin-left: 0px;" >
						<h4 class="col-md-8">환자명 : ${historyDetail.pName}(${fn:substring(historyDetail.pRnum,0,8)})</h4>
					</div>
						<button  onclick="javascript:window.close()" class="btn btn-warning " type="button" style="font-size: 0.8em;  position: absolute; right: 10px;top: 12px; ">닫 기</button>
					<!--end card-header  -->
					<div class="card-body pad">
							...
							<div class="col-md-6" style="display: contents;">
								<div class="form-group" style="width: 300px; display: contents;">
									 <h5 style="margin-top: -8px; padding-left: 15px;">진료일시: <fmt:formatDate value="${historyDetail.mDate}" pattern="yyyy-MM-dd HH:mm" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;담당의:${historyDetail.dId}&nbsp;&nbsp;&nbsp;</h5>
								</div>
							</div>
				...
				<ul class="list-group">
					<c:forEach items="${commentList}" var="comment">
						...
						<li class="list-group-item"><strong> <img alt="프로필" class="rounded-circle"
								src="<%=request.getContextPath()%>/doctor/getPic?dId=${comment.dId}"
...
<input type = "hidden" name = "taNo" value="${historyDetail.taNo}"/>
					...
					<strong><img alt="프로필" class="rounded-circle"
						src="<%=request.getContextPath()%>/doctor/getPic?dId=${vo.dId}" style="width: 40px; height: 40px;">&emsp;${vo.dName}/${vo.maName}</strong>
					<button  onclick="replyRegist_go()"class="btn btn-success" type="submit" id="replyRegist"style=" margin-top: -3px;">등록</button>
...
<!-- <form role="commentInsert" method="post" action="replyRegist.do" name="replyRegistForm"> -->
<%-- <input type = "hidden" name = "dId" value="${vo.dId}"/> --%>
<%-- <input type= "hidden" name = "comNo" value="${commentList[0].comNo}"/> --%>
<%-- <input type="hidden" name = "coNo" value="${historyDetail.coNo}"/> --%>
<%-- <input type = "hidden" name = "taNo" value="${historyDetail.taNo}"/> --%>

<!-- 							<div class="col-md-12"> -->
<!-- 									<div class="profile-image"> -->
<%-- 										<img src="getPic?dPic=${vo.dPic}" class="rounded-circle circle-border m-b-md" alt="profile"> --%>
<!-- 									</div> -->
<!-- 									<div class="profile-info padding10"> -->
<!-- 										<div class=""> -->
<!-- 											<div> -->
<%-- 												<h5>${vo.maName} <button type="button" class="btn btn-success" id="replyAddBtn" onclick="replyRegist_go()">ADD REPLY</button></h5> --%>
<%-- 												<h5 class="no-margins font-bold padding3" style="padding-bottom: 6px;">${vo.dName}</h5> --%>
<!-- <input name="comContent" style="font-size: 0.8rem;" class="form-control" type="text"	placeholder="내용을 입력해주세요" id="newReplyText"> -->
