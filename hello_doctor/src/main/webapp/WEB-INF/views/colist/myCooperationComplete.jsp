			...
			<div class="row">
				<c:forEach items="${myCooperation_complete}" var="mycomplete">
					<div class="col-lg-3" style="padding-left: 0px;">
						<div class="contact-box demo3" style="height: 165px; box-shadow: 1px 1px 1px 1px lightblue;" onclick="cooperationDetail('${mycomplete.coRelease}')">
							<div class="col-8">
							<div class="col-10" style="float:left; margin-left: -15px;">
								<h3>
									<strong>협진시작일&nbsp;&nbsp;${mycomplete.coStartDate} </strong><br>
								...
								<p>환자명&emsp;${mycomplete.pName}</p>
								<p>주상병&emsp;${mycomplete.coDisease}</p>
								<p>주치의 &emsp;${mycomplete.dName} ${mycomplete.maName}
								<img alt="프로필" class="rounded-circle" src="<%=request.getContextPath()%>/doctor/getPic?dId=${mycomplete.dId}" style="display: inline-block; margin-left:10px;width: 35px; height: 35px; text-align: left; vertical-align: -21px;">
								</p>
<!-- 								<p>의료진 &emsp;</p> -->
<!-- 								<div class="doctors"> -->
